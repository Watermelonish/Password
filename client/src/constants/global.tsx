...
export const allRules: IRule[] = [
    ...
    // },
    {
        id: 8,
        header: 'Rule 9',
        text: 'Your password must include the answer to the parallel vision picture hidden in the puzzle.',
        status: 'notShown',
        shown: false,
    ...
    },
    {
        id: 9,
        header: 'Rule 10',
        text: 'Your password must include the country name of the panarama',
        status: 'notShown',
        shown: false,
        validation: validate9,
        panorama: true,
...
allRules.forEach(el=>el.firstTime=true)
allRules.forEach(el=>el.prevStatus='notShown')
 ...
 export const sortHelper = (array:IRule[])=> {
    ...
    return firstArr.sort((a, b)=> b.id - a.id).concat(secondArr.sort((a, b)=> b.id - a.id))
  }